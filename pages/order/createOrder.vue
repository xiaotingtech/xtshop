<template>
	<view>
		...
		<navigator url="/pages/address/address?source=1" class="address-section">
			<view v-if="JSON.stringify(addressData)=='{}'" class="order-content">
				<text class="yticon icon-shouhuodizhi"></text>
				<view class="cen">
					<view class="top">
						<text class="name">点我去新增地址</text>
					</view>
				</view>
			</view>
			<view v-else class="order-content">
				...
				<view class="cen">
					...
					<text class="address">{{addressData.address}} {{addressData.address_door}}</text>
				</view>
		...
		<view class="goods-section">
			...
			<view 
				...
				<view class="right">
					...
					<text class="spec">{{item.property_value}}</text>
			      ...
			      uni.requestPayment({
			        ...
			        success: e => {
			          if(e.errMsg== "requestPayment:ok"){
			            this.checkPayback(this.order_no);
			          }else{
